...
const makeGraph = (data) => {
  ...
  for (let i = 0; i < totalDates - 1; i++) {
    ...
    d3.select("#info").text("The following chart represents days with quarter, new, or full moons. The planets' place in the ecliptic will display chronological order.")
